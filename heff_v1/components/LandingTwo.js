...
const Top = () => {
    return (
        <Box zIndex={0} pos='relative' display='block' >
            <Image objectFit='cover' layout='responsive' width={1440} height={311.5} src={blueTop} alt='Top of Blue Background' />
        </Box>
    )
}
...
const Bottom = () => {
    return (
        <Box zIndex={0} pos='relative'  display='block' >
            <Image objectFit='cover' layout='responsive' width={1441} height={479} src={blueBottom} alt='Bottom of Blue Background' />
        </Box>
    )
}
