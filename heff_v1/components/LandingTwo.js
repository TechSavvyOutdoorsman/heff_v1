...
const Top = () => {
    return (
        <Box zIndex={0} pos='relative' overflow='hidden' display='block'>
            <Image objectFit='cover' layout='responsive' width={1441} height={360} src={blueTop} alt='Top of Blue Background' />
        </Box>
    )
}
